...
namespace edumis.Models.Tenders;

[Table("tbweb_tenders")]
public class TendersModel : BaseEntity<long>
{   
    [Column(name: "financialyear", TypeName = "varchar(10)")]
    public string FinancialYear { get; set; } = default!;

    [Column(name: "tenderdate", TypeName = "date")]   
    ...
    [Column(name: "expirydate", TypeName = "date")]    
    public DateOnly ExpiryDate { get; set; }

    [Column(name: "expirytime", TypeName = "time")]
